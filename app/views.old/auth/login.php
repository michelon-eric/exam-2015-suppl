                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                           hx-get="<?= base_url() ?>auth/<?= $type === 'regular' ? 'user' : 'manager' ?>/register"
                ...
                <div class="mt-5">
                    ...
                    <form action="#" method="">
                        <div class="grid gap-y-4">
                            ...
                            <button id="button-login" type="button"
                                    class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                    hx-post="<?= base_url() ?>auth/login" hx-trigger="click" hx-swap="none"
                                    hx-include="#email, #password, #remember-me"
                                    hx-on::after-request="loginCallback(htmx, null, event)" hx-redirect="true">
                                Sign in
                            </button>
                        </div>
                    </form>
