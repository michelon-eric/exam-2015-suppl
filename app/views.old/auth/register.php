                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                           hx-get="<?= base_url() ?>auth/<?= $type === 'regular' ? 'user' : 'manager' ?>/login"
                           hx-trigger="click" hx-target="#content">
                            Log in here
                        </a>
                    </p>
                </div>
                    ...
                    <form id="register-form">
                        <div class=" grid gap-y-4">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="first-name" name="first-name"
                                           ...
                                           required aria-describedby="first-name">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" id="last-name" name="last-name"
                                           class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                           required aria-describedby="last-name">
                                    <div class="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                                        <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor"
                                             viewBox="0 0 16 16" aria-hidden="true">
                                            <path
                            ...
                            <div class="flex items-center">
                                <div class="flex">
                                    <input id="tos-accept" name="tos-accept" type="checkbox"
                                           class="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 pointer-events-none focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800">
                                </div>
                                <div class="ms-3">
                                    <label for="tos-accept" class="text-sm dark:text-white">I accept the <a
                                           class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                           href="<?= base_url() ?>tos">Terms and Conditions</a></label>
                                </div>
                            </div>
                            <!-- End Checkbox -->
                            ...
                            <button id="button-register" type="button"
                                    ...
                                    hx-post="<?= base_url() ?>auth/register" hx-trigger="click" hx-swap="none"
                                    hx-include="#email, #password, #confirm-password, #first-name, #last-name"
                                    hx-on::after-request="registerCallback(htmx, null, event)"
                                    hx-redirect="true">Register</button>
                        </div>
                    </form>
                    <!-- End Form -->
                </div>
