...
<script type="module" src="<?= assets_path() ?>js/auth/register.js" defer></script>
<?= $this->end_section() ?>
            ...
            <div class="p-4 sm:p-7">
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" hx-get="<?= base_url() ?>auth/<?= $type === 'regular' ? 'user' : 'manager' ?>/login" hx-trigger="click" hx-target="#content">
                            Log in here
                        </a>
                    </p>
                </div>
                    ...
                    <form action="#" method="">
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                ...
                                <p class="hidden text-xs text-red-600 mt-2" id="email-error-2">Email address is already registered</p>
                            </div>
                            <!-- End Form Group -->
